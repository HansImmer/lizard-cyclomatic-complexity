...
export default {
  ...
  provideLinter () {
    return {
      ...
      scope: 'file',
      lintsOnChange: false,
      grammarScopes: ['source.c', 'source.python', 'source.python.django', 'source.cpp', 'source.objc', 'source.objcpp', 'text.html.php', 'source.php', 'source.ruby', 'source.swift', 'source.go', 'source.lua', 'source.rust'],
      lint: async (editor) => {
